...
export default function HotPage() {
  ...
  const queryKey = ["mengla", "hot", primaryCatId, dateType, timest];

  const query = useQuery({
    queryKey,
    queryFn: () => queryMengla(buildQueryParams("hot", primaryCatId, period, timest)),
  ...
  const list = useRankList(pickPayload(query.data), "hotList");
